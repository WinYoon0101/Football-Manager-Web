...
interface AddPlayerDialogProps {
  ...
  teams: { id: number; name: string }[]; // object {id, name}
}
...
export default function AddPlayerDialog({
  ...
  const [playerType, setPlayerType] = useState<string | null>(null); // string "domestic" | "foreign"
  ...
  const handleSubmit = () => {
    ...
    onSubmit({
      name,
      birthDate,
      teamId: teams[0].id, // user chỉ có 1 đội
      playerType,           // gửi string "domestic" | "foreign"
      image: imageFile,
    });
      ...
      <DialogContent className="max-w-md">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <Input value={teams[0]?.name || ""} disabled />
          </div>
          ...
          <div className="space-y-1">
            ...
            <Select
              value={playerType || ""}
              onValueChange={(v) => setPlayerType(v)}
            >
              <SelectTrigger>
